...
$releaseBinDir = Join-Path -Path $PSScriptRoot "Ducode.QS2\bin\Release"
...
# Create sub folders
$buildOutputSubDir = Join-Path -Path $buildOutputDir "QuickStart2_$versionString"
...
# Build solution
& msbuild Ducode.QS2.sln /p:Configuration=Release
...
Rename-Item (Join-Path -Path $buildOutputBinDir "Ducode.QS2.exe") "quickstart2.exe"
